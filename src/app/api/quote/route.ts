      ...
      <td style="padding:24px 40px 0;">
        <div style="background:#f0f9ff;border:1px solid #bae6fd;border-radius:12px;padding:20px;">
          ...
          <p style="color:#0c4a6e;font-size:14px;margin:0 0 12px;">
            Draft Order <strong>${draftOrder.name}</strong> has been created.
          </p>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8f7f4;padding:40px 20px;">
        <tr><td align="center">
          <table width="600" cellpadding="0" cellspacing="0" style="background:white;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.06);">
            <tr><td style="background:#191b4e;padding:32px 40px;">
              <h1 style="color:white;margin:0;font-size:22px;font-weight:700;">NexGen Pharmaceuticals</h1>
              <p style="color:#42c2c1;margin:4px 0 0;font-size:13px;">B2B Quote Request</p>
            </td></tr>
            <tr><td style="background:#3296d2;padding:16px 40px;">
            ...
            <tr><td style="padding:32px 40px 0;">
              ...
              <p style="font-size:14px;margin:0;"><a href="mailto:${data.customer.email}" style="color:#3296d2;">${data.customer.email}</a></p>
            </td></tr>
            ...
            <tr><td style="padding:24px 40px 0;">
              <h2 style="color:#111;font-size:13px;font-weight:700;margin:0 0 16px;text-transform:uppercase;letter-spacing:0.05em;">Products (${totalItems} items)</h2>
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <th style="text-align:left;font-size:12px;color:#999;font-weight:600;text-transform:uppercase;padding-bottom:8px;">Product</th>
                  <th style="text-align:center;font-size:12px;color:#999;font-weight:600;text-transform:uppercase;padding-bottom:8px;">Qty</th>
                </tr>
                ${itemsHtml}
              </table>
            </td></tr>
            ...
            <tr><td style="padding:24px 40px 0;">
              ...
              <div style="background:#f8f7f4;border-left:3px solid #3296d2;padding:16px;border-radius:0 8px 8px 0;">
                <p style="color:#555;font-size:14px;margin:0;line-height:1.6;">${data.notes}</p>
              </div>
            </td></tr>` : ''}
            <tr><td style="padding:32px 40px;border-top:1px solid #eeebe6;margin-top:24px;">
              <p style="color:#999;font-size:12px;margin:0;text-align:center;">
                Reply to this email to respond to ${data.customer.name} at ${data.customer.email}
              </p>
            </td></tr>
          </table>
        </td></tr>

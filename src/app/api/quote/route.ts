...
async function createShopifyDraftOrder(
  ...
  try {
    ...
    console.log(`✅ Draft order: ${draft.name} — Total: $${draft.total_price}`);
        ...
        <tr>
          <td align="center">
            <table width="600" cellpadding="0" cellspacing="0" style="background:white;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.06);">
              <tr>
                <td style="background:#191b4e;padding:32px 40px;">
              ...
              <tr>
                <td style="background:#3296d2;padding:16px 40px;">
              ...
              <tr>
                <td style="padding:32px 40px 0;">
                  ...
                  <p style="font-size:14px;margin:0;">
                    <a href="mailto:${data.customer.email}" style="color:#3296d2;">${data.customer.email}</a>
                  </p>
                </td>
              </tr>
              <tr>
